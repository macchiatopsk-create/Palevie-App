...
export const catalogProducts: CatalogProduct[] = [
  {
    ...
    offers: [{ id: "of-rmd-jlt-06", retailer: "amazon", url: "https://www.amazon.com/s?k=romand+juicy+lasting+tint+06+figfig", priceLabel: "$11", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-rmd-jlt-09", retailer: "amazon", url: "https://www.amazon.com/s?k=romand+juicy+lasting+tint+09+litchi+coral", priceLabel: "$11", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-rmd-jlt-12", retailer: "amazon", url: "https://www.amazon.com/s?k=romand+juicy+lasting+tint+12+cherry+bomb", priceLabel: "$11", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-rmd-jlt-25", retailer: "amazon", url: "https://www.amazon.com/s?k=romand+juicy+lasting+tint+25+bare+grape", priceLabel: "$11", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-ppr-ink-17", retailer: "amazon", url: "https://www.amazon.com/s?k=peripera+ink+the+velvet+17+rosy+nude", priceLabel: "$9", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-ppr-ink-08", retailer: "amazon", url: "https://www.amazon.com/s?k=peripera+ink+the+velvet+08+sellout+red", priceLabel: "$9", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-ppr-ink-33", retailer: "amazon", url: "https://www.amazon.com/s?k=peripera+ink+the+velvet+33+pure+peach", priceLabel: "$9", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-mbl-vinyl-peachy", retailer: "amazon", url: "https://www.amazon.com/s?k=maybelline+superstay+vinyl+ink+peachy", priceLabel: "$10", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-mbl-matte-lover", retailer: "amazon", url: "https://www.amazon.com/s?k=maybelline+superstay+matte+ink+lover", priceLabel: "$10", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-elf-lipoil-rose", retailer: "amazon", url: "https://www.amazon.com/s?k=elf+glow+reviver+lip+oil+rose+envy", priceLabel: "$8", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-nyx-smlc-istanbul", retailer: "amazon", url: "https://www.amazon.com/s?k=nyx+soft+matte+lip+cream+istanbul", priceLabel: "$7", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-lng-balm-berry", retailer: "amazon", url: "https://www.amazon.com/s?k=laneige+lip+glowy+balm+berry", priceLabel: "$18", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-rmd-cheek-peach", retailer: "amazon", url: "https://www.amazon.com/s?k=romand+better+than+cheek+peach+whip", priceLabel: "$13", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-ppr-sun-rose", retailer: "amazon", url: "https://www.amazon.com/s?k=peripera+pure+blushed+sunshine+cheek+dried+rose", priceLabel: "$8", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-elf-putty-tahiti", retailer: "amazon", url: "https://www.amazon.com/s?k=elf+putty+blush+tahiti", priceLabel: "$7", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-rare-pinch-joy", retailer: "amazon", url: "https://www.amazon.com/s?k=rare+beauty+soft+pinch+liquid+blush+joy", priceLabel: "$23", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-mln-baked-lum", retailer: "amazon", url: "https://www.amazon.com/s?k=milani+baked+blush+luminoso", priceLabel: "$10", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-nars-orgasm", retailer: "amazon", url: "https://www.amazon.com/s?k=nars+blush+orgasm", priceLabel: "$32", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-clio-pro-01", retailer: "amazon", url: "https://www.amazon.com/s?k=clio+pro+eye+palette+01+simply+pink", priceLabel: "$32", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-clio-pro-02", retailer: "amazon", url: "https://www.amazon.com/s?k=clio+pro+eye+palette+02+brown+choux", priceLabel: "$32", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-rmd-btp-fog", retailer: "amazon", url: "https://www.amazon.com/s?k=romand+better+than+palette+dusty+fog+garden", priceLabel: "$25", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-elf-bite-rose", retailer: "amazon", url: "https://www.amazon.com/s?k=elf+bite+size+eyeshadow+rose+water", priceLabel: "$4", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-etude-wine", retailer: "amazon", url: "https://www.amazon.com/s?k=etude+play+color+eyes+wine+party", priceLabel: "$22", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-ppr-mood-02", retailer: "amazon", url: "https://www.amazon.com/s?k=peripera+all+take+mood+palette+02", priceLabel: "$21", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-rmd-veil", retailer: "amazon", url: "https://www.amazon.com/s?k=romand+see+through+veilighter", priceLabel: "$14", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-elf-halo-fair", retailer: "amazon", url: "https://www.amazon.com/s?k=elf+halo+glow+liquid+filter+fair", priceLabel: "$14", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-pf-butter-pearl", retailer: "amazon", url: "https://www.amazon.com/s?k=physicians+formula+butter+highlighter+pearl", priceLabel: "$11", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-tirtir-21n", retailer: "amazon", url: "https://www.amazon.com/s?k=tirtir+mask+fit+red+cushion+21n", priceLabel: "$25", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-cosrx-snail", retailer: "amazon", url: "https://www.amazon.com/s?k=cosrx+advanced+snail+96+mucin+power+essence", priceLabel: "$14", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-boj-glow", retailer: "amazon", url: "https://www.amazon.com/s?k=beauty+of+joseon+glow+deep+serum", priceLabel: "$17", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-boj-sun", retailer: "amazon", url: "https://www.amazon.com/s?k=beauty+of+joseon+relief+sun", priceLabel: "$16", currency: "USD", affiliateReady: false }],
  },
  {
    ...
    offers: [{ id: "of-anua-toner", retailer: "amazon", url: "https://www.amazon.com/s?k=anua+heartleaf+77+soothing+toner", priceLabel: "$18", currency: "USD", affiliateReady: false }],
  },
  {
