...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  { id: "white", text: "Look at the veins on your inner wrist in daylight.", help: "You can check right now — just flip your wrist.",
    options: [
      { label: "Blue or purple", t: -1.5, k: 0.5 },
      { label: "Green or olive", t: 1.5 },
      { label: "Honestly a mix of both" },
    ]},
  ...
  { id: "vividness", text: "Without any makeup, your features are…", help: "Brows, eyes, lips — do they stand out on their own?",
    options: [
      { label: "Crisp — they stand out sharply", c: 2, k: 0.5 },
      { label: "Soft — everything blends gently", c: -2, k: -0.5 },
      { label: "Somewhere in between", c: 0 },
    ]},
  { id: "depth", text: "In bright flash photos, your face usually…",
    options: [
      { label: "Washes out — I almost disappear", v: 2 },
      { label: "Stays clear and defined", v: -2 },
      { label: "Depends on the photo" },
    ]},
  { id: "lip", text: "Your natural lip color, with nothing on:",
    options: [
      { label: "Warm peach or coral", t: 1.5 },
      { label: "Cool rosy pink", t: -1.5 },
      { label: "Brick or terracotta", t: 1.5, v: -0.5, c: -0.5 },
      { label: "Deep berry or plum", t: -1, v: -0.5 },
      { label: "Vivid red-toned", c: 1.5, k: 1 },
      { label: "Pale, barely-there nude", c: -1 },
    ]},
  { id: "worst", text: "When you naturally flush — workout, embarrassment — your cheeks turn:",
    options: [
      { label: "Rosy or berry pink", t: -1.5 },
      { label: "Peachy or golden", t: 1 },
      { label: "Barely visible flush", v: 1, k: -1 },
      { label: "Cool crimson red", t: -1.5 },
